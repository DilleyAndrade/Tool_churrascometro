...
function calculate(){
    ...
    resultMeat.innerHTML = `<h2>${totalMeat} kg of meat</h2>`
    resultBeer.innerHTML = `<h2>${totalBeer} beer cans</h2>`
    resultSoda.innerHTML = `<h2>${totalSoda} liters of soda</h2>`
    resultCoal.innerHTML = `<h2>${totalCoal} Kg of coal</h2>`
}
